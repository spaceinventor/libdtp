 ...
 */
    ...
    extern const uint32_t CSPFTP_SESSION_VERSION;
 ...
 */
    ...
    extern int dtp_client_main(uint32_t server, uint16_t max_throughput, uint8_t timeout, bool resume, cspftp_t **session);

...
#include "cspftp/cspftp.h"
     ...
     * hence the "weak" attribute. If you do not implement it, a test implementation will get linked in.
     * 
     ...
     */
    extern bool get_payload_meta(dftp_payload_meta_t *meta, uint8_t payload_id) __attribute__((weak));
